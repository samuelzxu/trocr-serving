...
class ModelHandler(BaseHandler):
    ...
    def preprocess(self, data):
        ...
        raw_data = data[0].get("data")
        url_str = raw_data.decode("utf-8")
        image = Image.open(requests.get(url_str, stream=True).raw).convert("RGB")
    ...
    def inference(self, model_input):
        ...
        generated_ids = self.model.generate(model_input)
        return generated_ids
    ...
    def postprocess(self, inference_output):
        ...
        generated_text = self.processor.batch_decode(inference_output, skip_special_tokens=True)[0]
